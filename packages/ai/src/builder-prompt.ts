// SHARED HOME: @corvus/ai — moved verbatim from apps/web/lib/ai/builder-prompt.ts.
...
export function buildBuilderPrompt(): string {
  return [
    ...
    'Emit ONLY one fenced ```json block containing {"version": 1, "behaviors": [ ...opaque behavior entries... ]}; no prose outside the fence; keep output compact.',
  ].join('\n');
}
