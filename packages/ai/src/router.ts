// SHARED HOME: @corvus/ai — moved verbatim from apps/web/lib/ai/router.ts
// (only the relative import specifiers gained NodeNext `.js` suffixes). The web
// copy is now a re-export shim.
//
...
import type { LaneName, ProviderRoute } from './lanes.js';
