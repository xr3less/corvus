// SHARED HOME: @corvus/ai — moved verbatim from apps/web/lib/ai/lanes.ts.
// This is the single lane definition for every app (D-026/D-021); the web copy
  ...
  builder: [
    {
      ...
      // omits the flag. Persona routes are out of scope and untouched.
      baseURLEnv: WIRO_ENV,
    },
    {
      baseURL: WIRO_DEFAULT_BASE_URL,
