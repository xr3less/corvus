...
- [x] Tidy commit DONE 2026-09-19 evening (`9154d9e`: 31 files — grab install + 19 box/bench/stage-b reports + living docs incl. D-143; prettier clean, eslint clean, typecheck 4/4 green; tree clean, push pending via founder `! git push`)
...
- [ ] KI-033 trial wording — EITHER enforce the 3-day / 1-bot / sleep clock in product code OR remove the promise from the landing until it is enforced (founder picks A/B at task start; default B). Close when: landing promise == product behavior.
