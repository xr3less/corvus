...
**Last updated:** 2026-09-19 evening (BUILDER LIVE: wiro-key-001d swapped to len-32 candidate + live-smoke-003 SUCCESS `live` in 24s, 1 call 0.31696cr ~$0.0016; KI-015 resolved; HEAD `5c6c134` == origin/master). First deploy LIVE at `https://13-140-181-113.nip.io/` (D-136). KI-018 rebuilt-from-git (redirect + lint proof remain). KI-032 fixed + pushed. KI-030/031/033 untouched. Do not share the URL.
...
- [ ] KI-031 docs-true wave — rewrite `02`/`04`/`05`/`06`/`07`/`08`/`09`/`10` bodies so the next agent learns truth (banners already point at `Teknik_Borc/`; `07` drops `clone-pryzm`, which also closes KI-034 fully).
